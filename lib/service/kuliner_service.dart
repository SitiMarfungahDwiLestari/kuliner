...
class KulinerService {
  ...
  final String baseUrl = 'http://192.168.1.139/kuliner_jogja';
  ...
  // Fungsi untuk zmembuat kuliner baru di server
  Future<bool> createKuliner(Kuliner kuliner) async {
    final response = await http.post(
      Uri.parse(
          '$baseUrl/create_kuliner.php'), // Endpoint untuk menambah kuliner
      body: {
        'name': kuliner.name,
